    ...
    return (
        ...
        >
            <Box sx={{ 
                ...
                <Grid container spacing={3} sx={{ flex: 1, minHeight: 0, overflow: 'hidden', height: '100%' }}>
                    {/* Basic Information Section - Left Side (2/5) */}
                    ...
                    {/* Permissions Section - Right Side (3/5) */}
                    <Grid item xs={12} md={7.2} sx={{ display: 'flex', flexDirection: 'column', minHeight: 0, width: { md: '60%' }, flexBasis: { md: '60%' }, maxWidth: { md: '60%' }, height: '100%' }}>
                        <Paper
                            elevation={0}
                            sx={{
                                p: 3,
